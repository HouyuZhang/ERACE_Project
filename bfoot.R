...
MCCORES=10	         # Number of CPU cores for parallel computation
MCCORES_MOTIF = 10     # How many motifs are calculated at the same time
FAST_AGGREGATION_MC_CORES = 10 # Number of CPU cores for less-memory dependent calculation 
...
getOutputDirAndFilename<- function(outputdir_base, dataname,  sitefilename, halfwidth) {
	...
	list(dir = od, filename = file.path(od, sprintf('../%s_on%s_%dbp_out.txt', dataname, hotspotname,halfwidth)))
}				
	...
	for (index in comparisonIndices) {
		for (halfwidth in halfwidthlist) {
			...
			outfilename=ScatterDataOut(dataname1=dataname1,
					...
					title = title,threshold=threshold,datadir1=datadir1,datadir2=datadir2, outputcsv=outputcsvfile,
					range=range	) 
...
CalcObservedExpectedCuts <- function(S, motif, tdensity,motifcenter=0, halfspan = 50, nuccodes=NA,motifwidth=0, ftable=NA) {
	...
	#  print(ExpectedCuts[1,1:10])
	#  print(observedsum[1:10])
	#  print(ExpectedRates[1,1:10])
	  #browser(text="1261")  #053117
...
show.baghull = !noBag,  show.loophull= !noFence,  show.whiskers=F,xlab=labx,ylab=laby, col.looppoint = 'purple',cex=1,pch=15, cex.lab=1.5,  cex.axis=1.5)
		points(datan$x[outeridx], datan$y[outeridx], pch=16, col= "pink")      # outer
		points(datan$x[inneridx], datan$y[inneridx], pch=18, col= "green")   # bag
		text(datan$x, datan$y, labels=nametoshow,adj=1.2, cex=1)
...
show.baghull = !noBag,  show.loophull= !noFence,  show.whiskers=F,xlab=labx,ylab=laby, col.looppoint = '#000000',cex=2,pch=0, cex.lab=1.5,  cex.axis=1.5, lwd = 3)
		...
		points(datan$x[qvalue < qvaluethreshold], datan$y[qvalue < qvaluethreshold],cex=2, pch=15, col= "#FF0000")   #  p-value < 0.05q
...
combineTwoHotspots <- function(csvfile1, csvfile2, name1, name2) {
	...
	#phs = data.frame(ID=1:length(phs$chr),phs)  这里就是多出来一行的地方，bug!!!
...
loadChromosomeRange<-function(refgenome) {
    ...
    mm10range = list('chr10'=c(1,130694993),'chr11'=c(1,122082543),
		'chr12'=c(1,120129022),'chr13'=c(1,120421639),
		'chr14'=c(1,124902244),'chr15'=c(1,104043685),
		'chr16'=c(1,98207768),'chr17'=c(1,94987271),
		'chr18'=c(1,90702639),'chr19'=c(1,61431566),
		'chr1'=c(1,195471971),'chr2'=c(1,182113224),
		'chr3'=c(1,160039680),'chr4'=c(1,156508116),
		'chr5'=c(1,151834684),'chr6'=c(1,149736546),
		'chr7'=c(1,145441459),'chr8'=c(1,129401213),
		'chr9'=c(1,124595110),'chrX'=c(1,171031299),'chrY'=c(1,91744698))
	
	hg38range = list('chr1'=c(1,248956422),'chr2'=c(1,242193529),'chr3'=c(1,198295559),
	'chr4'=c(1,190214555),'chr5'=c(1,181538259),'chr6'=c(1,170805979),'chr7'=c(1,159345973),
	'chrX'=c(1,156040895),'chr8'=c(1,145138636),'chr9'=c(1,138394717),'chr11'=c(1,135086622),'chr10'=c(1,133797422),
	'chr12'=c(1,133275309),'chr13'=c(1,114364328),'chr14'=c(1,107043718),'chr15'=c(1,101991189),'chr16'=c(1,90338345),
	'chr17'=c(1,83257441),'chr18'=c(1,80373285),'chr20'=c(1,64444167),'chr19'=c(1,58617616),'chrY'=c(1,57227415),
	'chr22'=c(1,50818468),'chr21'=c(1,46709983))
	
	rn5range = list('chr1'=c(1,290094216),'chr2'=c(1,285068071),'chr4'=c(1,248343840),'chr3'=c(1,183740530),
	'chr5'=c(1,177180328),'chr6'=c(1,156897508),'chrX'=c(1,154597545),'chr7'=c(1,143501887),'chr8'=c(1,132457389),'chr9'=c(1,121549591),
	'chr13'=c(1,118718031),'chr14'=c(1,115151701),'chr15'=c(1,114627140),'chr10'=c(1,112200500),'chr11'=c(1,93518069),'chr17'=c(1,92503511),
	'chr16'=c(1,90051983),'chr18'=c(1,87229863),'chr19'=c(1,72914587),'chr20'=c(1,57791882),'chr12'=c(1,54450796))
	
	rn6range = list('chr1'=c(1,282763074),'chr2'=c(1,266435125),'chr4'=c(1,184226339),'chr3'=c(1,177699992),'chr5'=c(1,173707219),
	'chrX'=c(1,159970021),'chr6'=c(1,147991367),'chr7'=c(1,145729302),'chr8'=c(1,133307652),
	'chr9'=c(1,122095297),'chr14'=c(1,115493446),'chr13'=c(1,114033958),'chr10'=c(1,112626471),
	'chr15'=c(1,111246239),'chr17'=c(1,90843779),'chr16'=c(1,90668790),'chr11'=c(1,90463843),
	'chr18'=c(1,88201929),'chr19'=c(1,62275575),'chr20'=c(1,56205956),'chr12'=c(1,52716770),'chrY'=c(1,3310458))

    genomeinfo=list("mm8"=mm8range, "mm9"=mm9range, "hg18"=hg18range, "hg19"=hg19range, "hg38"=hg38range,
		"rn5"=rn5range, "rn6"=rn6range, "mm10" = mm10range)
...
BuildCutCountProfileBAM <- function (bamfile='', dataname='', bgrfilename='', ftablefile='', refgenome='hg19', chroms=NA, compress=T, atac=F) {
   ...
   trackcolor='black'
	...
	gboption = sprintf("visibility=full maxHeightPixels=%d:%d:%d autoScale=on",heightPixel[1],heightPixel[2],heightPixel[3])
	description = sprintf('%s %s', dataname, getDateStamp())
